...
const NoteState = (props) => {
    ...
    // getNote
    const getNote = async () => {
        const url = `${process.env.REACT_APP_BASE_URL}/api/notes/fetch-all-notes`;
    ...
    const addNote = async (title, description, tag) => {
        ...
        const url = `${process.env.REACT_APP_BASE_URL}/api/notes/add-notes`;
        const response = await fetch(url, {
    ...
    const deleteNote = async (id) => {
        const url = `${process.env.REACT_APP_BASE_URL}/api/notes/delete-note/${id}`;
        const response = await fetch(url, {
    ...
    const updateNote=async (id,title,description,tag)=>{
        ...
        const url = `${process.env.REACT_APP_BASE_URL}/api/notes/update-note/${id}`;
        const response = await fetch(url, {
